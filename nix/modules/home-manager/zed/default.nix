...

{
  programs.zed-editor = {
    ...
    userSettings = {
        ...
        "Nord-Custom" = {
          ...
          syntax = {
            ...
            "constant.comment.todo" = {
              color = "#2E3440";
              background_color = "#EBCB8B";
              font_weight = 700;
            };
            "constant.comment.todo.text" = {
              color = "#ECEFF4";
            };
            "property.comment.fixme" = {
              color = "#2E3440";
              background_color = "#BF616A";
              font_weight = 700;
            };
            "property.comment.fixme.text" = {
              color = "#ECEFF4";
            };
            "property.comment.bug" = {
              color = "#2E3440";
              background_color = "#BF616A";
              font_weight = 700;
            };
            "property.comment.bug.text" = {
              color = "#ECEFF4";
            };
            ...
            "keyword.comment.hack" = {
              color = "#2E3440";
              background_color = "#D08770";
              font_style = "italic";
              font_weight = 700;
            };
            "keyword.comment.hack.text" = {
              color = "#ECEFF4";
            };
      ...
      ui_font_weight = 300;
      buffer_font_family = "SHCode JP Zen Haku";
    ...
    userKeymaps = [
      ...
      {
        bindings = { "cmd-shift-w" = null; };
      }
      {
        context = "Editor";
        bindings = { "cmd-shift-w" = "editor::WrapSelectionsInTag"; };
      }
      {
        context = "ProjectPanel";
        bindings = { "cmd-shift-c" = "project_panel::CollapseAllEntries"; };
      }
    ];
    themes = {
